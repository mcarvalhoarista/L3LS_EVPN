...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | DC1-SW1_eth2 | *trunk | *10 | *- | *- | 3 |
...
| Loopback100 | OVERLAY_VTEP_DIAGNOSTICS | OVERLAY | 10.100.100.4/32 |
...
| -------------- | --------------------- |
| OVERLAY | 10.100.100.4 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf OVERLAY address 10.100.100.4
```

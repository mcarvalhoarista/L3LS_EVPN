...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | DC1-SW1_eth1 | *trunk | *10 | *- | *- | 3 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | DC1-SW1 | switched | trunk | 10 | - | - | - | - | 3 | - |
...
| Loopback100 | OVERLAY_VTEP_DIAGNOSTICS | OVERLAY | 10.100.100.3/32 |
...
| -------------- | --------------------- |
| OVERLAY | 10.100.100.3 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf OVERLAY address 10.100.100.3
```

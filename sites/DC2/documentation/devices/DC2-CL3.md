...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | DC2-SW2_eth1 | *trunk | *20 | *- | *- | 3 |
...
| Loopback100 | OVERLAY_VTEP_DIAGNOSTICS | OVERLAY | 10.100.100.5/32 |
...
| -------------- | --------------------- |
| OVERLAY | 10.100.100.5 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf OVERLAY address 10.100.100.5
```
